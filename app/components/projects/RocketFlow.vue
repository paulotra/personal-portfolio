  ...
  <div class="max-w-[960px] mx-auto px-6 py-10 flex flex-col gap-6">
    <div class="flex flex-col md:flex-row gap-6">
      ...
      <div class="flex flex-col gap-6 md:flex-1 w-full">
        ...
        />
        <img
          src="/images/projects/rocket-flow/3.webp"
          v-bind="anim(2)"
          class="w-full img-shadow"
        />
      </div>
      <div class="md:flex-1">
        <img
          src="/images/projects/rocket-flow/4.webp"
          v-bind="anim(3)"
          class="w-full img-shadow"
        />
      </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
      ...
      <div class="flex flex-col gap-6 md:flex-1">
        ...
        />
        <img
          src="/images/projects/rocket-flow/7.webp"
          v-bind="anim(6)"
          class="w-full img-shadow"
        />
      </div>
    ...
    <div class="flex gap-6 flex-col">
      ...
      />
      <img
        src="/images/projects/rocket-flow/9.webp"
        v-bind="anim(8)"
        class="w-full img-shadow"
      />
    </div>
