<template>
  <div ref="sectionRef" class="relative flex flex-col gap-[54px]">
    ...
    <div class="flex items-end justify-between relative">
      <h2 :class="visible ? 'animate-slideDown' : 'opacity-0'" class="font-sans font-black text-4xl leading-[1.4] uppercase text-black">RECENT WORKS</h2>

      <!-- "design & development" decorative label -->
      <div :class="visible ? 'animate-slideDown [animation-delay:800ms]' : 'opacity-0'" class="absolute right-[360px] -top-[132px] rotate-[15deg] pointer-events-none">
        <p class="font-['Gochi_Hand'] text-[34px] leading-normal text-primary-500 text-center whitespace-pre">
          design <br> & <br> development
        </p>
      </div>

      <!-- Visit all projects -->
      <a href="#" :class="visible ? 'animate-slideDown' : 'opacity-0'" class="flex items-center gap-3 cursor-pointer">
        <span class="font-['Gochi_Hand'] text-3xl leading-10 text-neutral-700 whitespace-nowrap">Visit all projects</span>
        <img src="/images/works/visit-arrow.png" alt="" aria-hidden="true" class="h-[27px] w-[53px] object-cover" />
      </a>
    </div>
    ...
    <div class="grid grid-cols-3 gap-x-10 gap-y-[2.26rem]">
      ...
      <!-- Rocket Flow -->
      <Card :class="visible ? 'animate-slideDown [animation-delay:80ms]' : 'opacity-0'">
      ...
      <!-- ProphetX -->
      <Card :class="visible ? 'animate-slideDown [animation-delay:160ms]' : 'opacity-0'">
        <div class="flex flex-col gap-5 pb-[45.5px]">
          <div class="border-b border-neutral-300 h-[391px] w-full flex items-center justify-center">
      ...
      <!-- Cloudmazing -->
      <Card :class="visible ? 'animate-slideDown [animation-delay:400ms]' : 'opacity-0'">
        <div class="flex flex-col gap-5 pb-[45.5px]">
          <div class="border-b border-neutral-300 h-[391px] w-full flex items-center justify-center">
      ...
      <!-- 123declaratie -->
      <Card :class="visible ? 'animate-slideDown [animation-delay:480ms]' : 'opacity-0'">
        <div class="flex flex-col gap-5 pb-[45.5px]">
          <div class="border-b border-neutral-300 h-[391px] w-full flex items-center justify-center">
